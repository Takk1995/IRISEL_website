...
function FQApage() {
    ...
    return (
        <>
            ...
            <main className="FAQForm LeaveBlank">
                <div className="PageTitle">常見問題</div>
                <div className="FAQFormBlock">
                    <div className="FAQFormTitle">
                        <ul>
                            <li
          className={act === 'tab1' ? 'active' : ''}
          onClick={() => set('tab1')}>會員問題</li>
                            <li
          className={act === 'tab2' ? 'active' : ''}
          onClick={() => set('tab2')}>客製化服務問題</li>
                            <li
          className={act === 'tab3' ? 'active' : ''}
          onClick={() => set('tab3')}>配送問題</li>
                            <li
          className={act === 'tab4' ? 'active' : ''}
          onClick={() => set('tab4')}>退換貨問題</li>
                            <li
          className={act === 'tab5' ? 'active' : ''}
